...
export interface Product {
  ...
  universe: 'naturaleza' | 'aventura' | 'cultura' | 'origen';
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "P8HeroBlock".
 */
export interface P8HeroBlock {
  /**
   * Texte avant le mot manuscrit. Ex. « Un »
   */
  titleBefore?: string | null;
  /**
   * Un seul mot, rendu en Permanent Marker doré. Ex. « pedacito »
   */
  accentWord?: string | null;
  /**
   * Texte après le mot manuscrit. Ex. « de casa, donde estés. »
   */
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "P8HeroBlock_select".
 */
export interface P8HeroBlockSelect<T extends boolean = true> {
  titleBefore?: T;
  accentWord?: T;
  titleAfter?: T;
  ctaLabel?: T;
